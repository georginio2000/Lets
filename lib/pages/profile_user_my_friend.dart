          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                left: MediaQuery.of(context).size.width / 2 - 130, // Κεντράρουμε οριζόντια
                child: FriendsActivitiesWidgetNoButton(uid: uid), // Καλούμε το widget για activities και friends
              ),
              Positioned(
                top: 400,
